...
import { CardSlider_comp, Comments_comp, Motion_comp } from '@/components'
import { globalMessages } from '@/assets/globalMessages'

export function CrewPage_page(): JSX.Element {
  ...
  return (
    <Container>
      ...
      <Comments_comp crewName={String(query?.name).split('_').join(' ')} />
    </Container>
  )
}
